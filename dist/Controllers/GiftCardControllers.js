...
exports.GenerateAGiftCard = (0, AsyncHandler_1.AsyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (GetBusiness === null || GetBusiness === void 0 ? void 0 : GetBusiness.logo) {
        const GiftCard = yield GiftCardModels_1.default.create({
            name: GetBusiness === null || GetBusiness === void 0 ? void 0 : GetBusiness.companyName,
        ...
        return res.status(200).json({
            message: `A Gift card for ${GetBusiness === null || GetBusiness === void 0 ? void 0 : GetBusiness.companyName} with money worth of ${moneyWorth} successfully generated`,
            data: GiftCard,
        });
    }
}));
...
exports.BusinessGiftCard = (0, AsyncHandler_1.AsyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!Business) {
        ...
        return res.status(200).json({
            message: `Successfully got all ${Business === null || Business === void 0 ? void 0 : Business.giftCard.length} gift cards generated by ${Business === null || Business === void 0 ? void 0 : Business.companyName}`,
            data: Business,
        });
    }
}));
